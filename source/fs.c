...
void flashinit(void)
{
	...
	gpio_set(BP_FS_CS_PORT, BP_FS_CS_PIN);
	spi_reset(BP_FS_SPI);
	spi_init_master(BP_FS_SPI, SPI_CR1_BAUDRATE_FPCLK_DIV_8, SPI_CR1_CPOL_CLK_TO_1_WHEN_IDLE, SPI_CR1_CPHA_CLK_TRANSITION_2, SPI_CR1_DFF_8BIT, SPI_CR1_MSBFIRST);
